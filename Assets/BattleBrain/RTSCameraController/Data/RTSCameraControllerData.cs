...
namespace GalacticBoundStudios.BattleBrain.CameraControls
{
    ...
    // Use this component to lock the camera controls
    public struct RTSCameraLockControlsTag : IComponentData
    {
