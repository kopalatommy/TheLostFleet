...
namespace GalacticBoundStudios.DataScribes.Managed.Trees
{
    ...
    public class Trie : System.Collections.Generic.IEnumerable<string>, System.Collections.IEnumerable
    {
        ...
        {
            protected GalacticBoundStudios.DataScribes.Managed.Queues.Queue<string> queue = null;
            ...
            {
                this.tree = tree;
                queue = new GalacticBoundStudios.DataScribes.Managed.Queues.Queue<string>();
